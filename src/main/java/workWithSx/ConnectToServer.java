...
public class ConnectToServer implements TCPConnectionListener, Runnable {
    ...
    public void onConnectionReady(TCPConnection tcpConnection) {
        System.out.println("======> ConnectToServer -> onConnectionReady() -> Connect ready to Ip: " + serverIp);
    ...
    public void onDisconnect(TCPConnection tcpConnection) {
        System.out.println("===> ConnectToServer -> onDisconnect() -> Disconnected from IP: " + serverIp);
    }
